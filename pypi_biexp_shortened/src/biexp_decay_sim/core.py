...
if __name__ == "__main__":
    ...
    true_lifetimes_1 = np.logspace(np.log10(1),np.log10(1.5),2,endpoint=True)
    ...
    for l1 in true_lifetimes_1:
        for l2 in true_lifetime_2:
            for a1 in true_fractions_1:
                ...
                export_decay_3d_withnoise(multi_times,data_block,f"G:\\MNtissueproject_CLEANED20250716\\biexp_test\\MULTI_withnoise_np_500_t1_{np.round(l1,2)}_t2_{np.round(l2,2)}_a1_{np.round(a1,2)}_a2_{np.round((1-a1),2)}_data.tif", box_size=(width,height))